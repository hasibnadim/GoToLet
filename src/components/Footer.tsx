        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Your trusted partner for housing in Bangladesh.
            </p> 
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link href="/support" className="hover:text-white transition-colors"><span className="animate-pulse">Live</span> Support</Link></li>
              <li><Link href="/info/contact-us" className="hover:text-white transition-colors">Contact us</Link></li>
            </ul>
          </div>
